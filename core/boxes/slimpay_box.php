 ...
 */
class slimpaybox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "slimpay@slimpay";
    public $boxlabel;
    public $depends = array("slimpay");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/slimpay/class/slimpay.class.php";
